...
<div class="container">
				...
				<div class="col-sm-6">
					<div class="your-order">
							...
							<div class="your-order-item">
								<div>
									...
									<div class="media">
										...
										<img width="35%" src="image/product/{{$product['item']['image']}}" alt="" class="pull-left">
						...
						<div class="your-order-item">
							...
							<div class="pull-right">
								<h5 class="color-black">@if(Session::has('cart')) {{Session('cart')->totalPrice}} @else 0 đồng @endif</h5>
							</div>
							<div class="clearfix"></div>
						</div>
						@endif
						...
						<ul class="payment_methods methods">
							<li class="payment_method_bacs">
								...
								<div class="payment_box payment_method_bacs" style="display: block;">
									Cửa hàng sẽ gửi hàng đến địa chỉ của bạn. Bạn xem hàng rồi thanh toán cho nhân viên giao hàng.
								</div>
							</li>

							<li class="payment_method_cheque">
								<input id="payment_method_cheque" type="radio" class="input-radio" name="ATM" value="cheque" data-order_button_text="">
	...
	<div class="export">
     ...
     <a href ="{{ url('export') }}" class="btn btn-info export" id="export-button"> Xuất bảng product </a>
</div>
</div> <!-- #content -->
</div> <!-- .container -->
