                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a ><img src="image/product/{{$new->image}}" alt=""></a>
                                    </div>
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{ url('add-to-cart/'.$new->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary" href="{{ url('product/'.$new->id) }}">Details <i class="fa fa-chevron-right"></i></a>
                                        <a class="product-wish" ><i class="fa fa-heart"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <a ><i class='fa fa-heart'><img src="image/product/{{$spkm->image}}" alt=""></i></a>
                                        </div>
                                        <div class="single-item-body">
                                        ...
                                        <div class="single-item-caption">
                                            <a class="add-to-cart pull-left" href="{{ url('add-to-cart/'.$spkm->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                            <a class="beta-btn primary" href="{{ url('product/'.$spkm->id) }}">Details <i class="fa fa-chevron-right"></i></a>
                                            <a class="product-wish" ><i class="fa fa-heart"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
